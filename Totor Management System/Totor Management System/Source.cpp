...
void initialize_data() {
	...
	tutorDetails[0].hourlyPayRate = 40; tutorDetails[0].center.tuitionCenterCode = 1002; tutorDetails[0].center.tuitionCenterName = "Beta";
	tutorDetails[0].center.tuitionCenterLocation = "Bukit Jalil"; tutorDetails[0].teachSub.subjectCode = 2001;
	tutorDetails[0].teachSub.subjectName = "Chinese"; tutorDetails[0].phoneNumber = "60134020303";
	tutorDetails[0].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[0].rating = 4;
	...
	tutorDetails[1].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[1].rating = 5;
	tutorDetails[2].tutorID = 3; tutorDetails[2].tutorFirstName = "C"; tutorDetails[2].tutorLastName = "Lao";
	tutorDetails[2].datejoined.dd = 23; tutorDetails[2].datejoined.mm = 4; tutorDetails[2].datejoined.yyyy = 1999;
	tutorDetails[2].hourlyPayRate = 40; tutorDetails[2].center.tuitionCenterCode = 1003; tutorDetails[2].center.tuitionCenterName = "Omega";
	tutorDetails[2].center.tuitionCenterLocation = "Puchong"; tutorDetails[2].teachSub.subjectCode = 2001;
	tutorDetails[2].teachSub.subjectName = "Chinese"; tutorDetails[2].phoneNumber = "60134070303";
	tutorDetails[2].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[2].rating = 2;
	tutorDetails[3].tutorID = 2; tutorDetails[3].tutorFirstName = "D"; tutorDetails[3].tutorLastName = "Lao";
	tutorDetails[3].datejoined.dd = 23; tutorDetails[3].datejoined.mm = 4; tutorDetails[3].datejoined.yyyy = 1999;
	tutorDetails[3].hourlyPayRate = 40; tutorDetails[3].center.tuitionCenterCode = 1005; tutorDetails[3].center.tuitionCenterName = "Super";
	tutorDetails[3].center.tuitionCenterLocation = "Kepong"; tutorDetails[3].teachSub.subjectCode = 2001;
	tutorDetails[3].teachSub.subjectName = "Chinese"; tutorDetails[3].phoneNumber = "60124020303";
	tutorDetails[3].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[3].rating = 1;
	tutorDetails[4].tutorID = 5; tutorDetails[4].tutorFirstName = "E"; tutorDetails[4].tutorLastName = "Lao";
	tutorDetails[4].datejoined.dd = 23; tutorDetails[4].datejoined.mm = 4; tutorDetails[4].datejoined.yyyy = 1999;
	tutorDetails[4].hourlyPayRate = 40; tutorDetails[4].center.tuitionCenterCode = 1004; tutorDetails[4].center.tuitionCenterName = "Lamda";
	tutorDetails[4].center.tuitionCenterLocation = "Cheras"; tutorDetails[4].teachSub.subjectCode = 2001;
	tutorDetails[4].teachSub.subjectName = "Chinese"; tutorDetails[4].phoneNumber = "60174020303";
	tutorDetails[4].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[4].rating = 1;
	...
	tutorDetails[5].hourlyPayRate = 40; tutorDetails[5].center.tuitionCenterCode = 1003; tutorDetails[5].center.tuitionCenterName = "Omega";
	tutorDetails[5].center.tuitionCenterLocation = "Puchong"; tutorDetails[5].teachSub.subjectCode = 2001;
	tutorDetails[5].teachSub.subjectName = "Chinese"; tutorDetails[5].phoneNumber = "0124020303";
	tutorDetails[5].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[5].rating = 5;
	tutorDetails[6].tutorID = 4; tutorDetails[6].tutorFirstName = "G"; tutorDetails[6].tutorLastName = "Lao";
	tutorDetails[6].datejoined.dd = 23; tutorDetails[6].datejoined.mm = 4; tutorDetails[6].datejoined.yyyy = 1999;
	tutorDetails[6].hourlyPayRate = 40; tutorDetails[6].center.tuitionCenterCode = 1005; tutorDetails[6].center.tuitionCenterName = "Super";
	tutorDetails[6].center.tuitionCenterLocation = "Kepong"; tutorDetails[6].teachSub.subjectCode = 2001;
	tutorDetails[6].teachSub.subjectName = "Chinese"; tutorDetails[6].phoneNumber = "0134020304";
	tutorDetails[6].tutorAddress = "32, Medan Kurau 2, 14000"; tutorDetails[6].rating = 2;
	tutorID = 8;
}
